<template>
    <div>
        <div :class="['input-group', { input__valid: !errorMessage && modelValue }]">
            ...
            <span :class="['input-group-suffix', { 'font-iranSans': tooman }]">{{ suffix }}</span>
            <svg v-if="showCheckBox && !errorMessage" class="input__valid-icon" width="24" height="24" viewBox="0 0 24 24"
                fill="none">
